...
%
%Given the amount of \emph{a priori} information we can make a fairly non-trivial synthetic model to test various forms of constraints. The primary source of information for the creation of the sysnthetic model are drill hole logs of the kimberlite pipe. (Discuss source). From these drill holes, a data set representing the outer surface of the geological units (PK and HK), was created. These are shown in \autoref{fig:TKCdataPKHK} along with the VTEM magnetic data over top of DO27, and the mesh used throughout the rest of this section.
%
%\begin{figure} [h]
%    \centering
