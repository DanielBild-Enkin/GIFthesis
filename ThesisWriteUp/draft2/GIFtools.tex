...
%!TEX root = thesisDraft2.tex


% comments from doug
%less images of the swing GUIs (add to an appendix of recipes)
%more images of what exactly I am including
%talk about remanence
%talk about component parts
%	Voxel Model
% 	active voxel model
%	geo model
%	vector fld model
